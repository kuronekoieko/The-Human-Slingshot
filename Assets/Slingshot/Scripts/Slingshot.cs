    ...
    void Update()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            else
            {
                ...
                rightElasticLine.SetPosition(1, new Vector3(0, 0, -7));
                leftElasticLine.SetPosition(1, new Vector3(0, 0, -7));
                metalSphere.transform.localPosition = new Vector3(-1.42f, 2.286f, -5.3f);
                leather.transform.localPosition = new Vector3(-1.42f, 2.286f, -5.8f);
                leatherLine.transform.localPosition = new Vector3(-1.42f, 2.286f, -5.8f);
            }
